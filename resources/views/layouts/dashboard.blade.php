            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse col" id="mynavbar">
                    <ul class="navbar-nav me-auto d-flex flex-row justify-content-end">
                        @auth
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)"><i class="fas fa-user"></i> View Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0)"><i class="fas fa-user-edit"></i> Edit Profile</a>
                            </li>
                        @endauth
